...
function Header() {
  return (
    <div className = " sticky top-0 h-16 w-full bg-white flex place-items-center justify-items-center justify-between">
       ...
       <Image src={facebook} alt="logo" className=' w-14'/>
            ...
            <IoIosSearch />
                <input type="text" placeholder='Search Facebook' className = "focus:outline-none bg-inherit w-full mx-1" />
            </div>
       </div>
